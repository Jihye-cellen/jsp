...
<nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
  <div class="container-fluid">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="/pro/list">교수관리</a></li>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="/stu/list">학생관리</a></li>
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      <li><a class="dropdown-item" href="/cou/list">강좌관리</a></li>
      <li><a class="dropdown-item" href="/cou/insert">강좌등록</a></li>
    </ul>
  </li>
