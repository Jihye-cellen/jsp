			...
			<div class="card-body">
				<form name="frm">
					...
					<div class="input-group mb-2">
						...
						<input  value="${cou.capacity}" name="capacity" class="form-control">
					</div>
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center">강의실</span>
						<input name="room"  value="${cou.room}" class="form-control" type="number">
					</div>
					<div class="input-group mb-2">
						<span class="input-group-text justify-content-center">강의시수</span>
						<input name="hours" class="form-control"  value="${cou.hours}" >
					</div>
					<div class="text-center mt-3">
						<button class="btn btn-warning">강좌수정</button>
